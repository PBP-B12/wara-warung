...
from menu.views import show_main, edit_menu, delete_menu, add_menu, add_menu_ajax, show_xml, show_json, get_warungs, add_menu_flutter, edit_menu_flutter, show_json_flutter, delete_menu_json
...
urlpatterns = [
    ...
    path('delete-json/<int:id>', delete_menu_json, name='delete_menu_json'),
